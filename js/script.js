...
function start(){
    gapi.client.init({
        'apiKey': 'AIzaSyDQguaftPfRwSfgRO-YyqBsyTRA8Jb-laM',
...
function search(target){
    gapi.client.init({
        ...
        while(videosWrapper.firstChild){            //first or socond method to clean html
...
//AIzaSyDQguaftPfRwSfgRO-YyqBsyTRA8Jb-laM myKey
//add player youtube
